...
const INITIAL_DESKTOP_ITEMS: DesktopItem[] = [
    ...
    { id: 'security_center', name: 'Security Center', type: 'app', icon: ShieldAlert, appId: 'security_center', bgColor: 'bg-gradient-to-br from-red-600 via-rose-700 to-zinc-950 border border-red-500/30 shadow-md' },
    { id: 'self_audit_scanner', name: 'Self-Audit Scanner', type: 'app', icon: AlertTriangle, appId: 'self_audit_scanner', bgColor: 'bg-gradient-to-br from-orange-600 via-amber-700 to-zinc-950 border border-orange-500/30 shadow-md' },
    ...
    { id: 'anomaly_alert', name: 'Anomaly & Alerts', type: 'app', icon: AlertTriangle, appId: 'anomaly_alert', bgColor: 'bg-gradient-to-br from-red-600 via-red-700 to-zinc-950 border border-red-500/30 shadow-md' },
    { id: 'session_recorder', name: 'Session Recorder', type: 'app', icon: Clock, appId: 'session_recorder', bgColor: 'bg-gradient-to-br from-orange-600 via-orange-700 to-zinc-950 border border-orange-500/30 shadow-md' },
